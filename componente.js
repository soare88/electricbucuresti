        ...
        this.innerHTML = `
            <header>
                <div class="header-inner" style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
                    ...
                    <!-- Partea Dreaptă: Meniul + Butoanele de Acțiune Separate -->
                    <div style="display: flex; align-items: center; gap: 30px;">
                        <!-- Meniul de Navigare Curat -->
                        <nav class="main-nav">
                            <ul style="display: flex; align-items: center; gap: 25px; margin: 0; padding: 0; list-style: none;">
                        ...
                        <!-- Grup Dedicat pentru Telefon și WhatsApp -->
                        <div style="display: flex; align-items: center; gap: 10px; border-left: 1px solid rgba(255, 255, 255, 0.1); padding-left: 20px;">
                            <a href="tel:0765948524" style="color: #f8fafc; background: rgba(255, 255, 255, 0.05); padding: 8px 12px; border-radius: 6px; border: 1px solid rgba(255, 255, 255, 0.1); text-decoration: none; font-size: 13px; font-weight: 600; display: flex; align-items: center; gap: 6px; transition: background 0.2s;">
                                📞 0765 948 524
                            </a>
                            <a href="https://wa.me/40765948524?text=Salut,%20am%20nevoie%20de%20un%20electrician." target="_blank" style="background-color: #25d366; color: #ffffff !important; padding: 8px 14px; border-radius: 6px; text-decoration: none; font-size: 13px; font-weight: 600; display: flex; align-items: center; gap: 6px; transition: opacity 0.2s;">
