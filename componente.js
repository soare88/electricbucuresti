    ...
    connectedCallback() {
        this.innerHTML = `
            <header style="padding: 0;">
                <!-- Bara de Sus: Telefon și WhatsApp -->
                <div style="background-color: #0b0c10; border-bottom: 1px solid rgba(255, 255, 255, 0.08); padding: 8px 5%; display: flex; justify-content: flex-end; align-items: center; gap: 15px;">
                    <a href="tel:0765948524" style="color: #f8fafc; text-decoration: none; font-size: 14px; font-weight: 600; display: flex; align-items: center; gap: 6px;">
                        📞 0765 948 524
                    </a>
                    <a href="https://wa.me/40765948524?text=Salut,%20am%20nevoie%20de%20un%20electrician." target="_blank" style="background-color: #25d366; color: #ffffff; padding: 4px 12px; border-radius: 20px; text-decoration: none; font-size: 13px; font-weight: 600; display: flex; align-items: center; gap: 6px;">
                ...
                <!-- Meniul Principal -->
                <div class="header-inner" style="padding: 15px 5%;">
