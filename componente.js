        ...
        this.innerHTML = `
            <header>
                <div class="header-inner" style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
                    ...
                    <!-- Meniul principal integrat cu butoanele de contact pe aceeași linie uniformă -->
                    <nav class="main-nav">
                        <ul style="display: flex; align-items: center; gap: 20px; margin: 0; padding: 0; list-style: none;">
                            ...
                            <!-- Telefon -->
                            <li>
                                <a href="tel:0765948524" style="color: #f8fafc; background: #16181d; padding: 7px 12px; border-radius: 6px; border: 1px solid rgba(255, 255, 255, 0.12); text-decoration: none; font-size: 13px; font-weight: 600; display: flex; align-items: center; gap: 6px; text-transform: none;">
                                    📞 0765 948 524
                                </a>
                            </li>
                            ...
                            <!-- WhatsApp -->
                            <li>
                                <a href="https://wa.me/40765948524?text=Salut,%20am%20nevoie%20de%20un%20electrician." target="_blank" style="background-color: #25d366; color: #ffffff !important; padding: 7px 12px; border-radius: 6px; text-decoration: none; font-size: 13px; font-weight: 600; display: flex; align-items: center; gap: 6px; text-transform: none;">
