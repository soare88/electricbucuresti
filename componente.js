        ...
        this.innerHTML = `
            <header>
                <div class="header-inner" style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
                    ...
                    <!-- Telefon și WhatsApp pe același rând -->
                    <div class="header-contact" style="display: flex; align-items: center; gap: 15px;">
                        <a href="tel:0765948524" style="color: #f8fafc; text-decoration: none; font-size: 14px; font-weight: 600; display: flex; align-items: center; gap: 6px; white-space: nowrap;">
                            📞 0765 948 524
                        </a>
                        <a href="https://wa.me/40765948524?text=Salut,%20am%20nevoie%20de%20un%20electrician." target="_blank" style="background-color: #25d366; color: #ffffff; padding: 6px 12px; border-radius: 20px; text-decoration: none; font-size: 13px; font-weight: 600; display: flex; align-items: center; gap: 6px; white-space: nowrap;">
