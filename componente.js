        ...
        this.innerHTML = `
            <header>
                <div class="header-inner" style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
                    ...
                    <!-- Partea Dreaptă: Meniul + Butoanele de Contact Unitar -->
                    <div style="display: flex; align-items: center; gap: 30px;">
                        ...
                        <!-- Butoane de Rapid Contact (Stilizate Profesional) -->
                        <div style="display: flex; align-items: center; gap: 10px;">
                            <a href="tel:0765948524" style="color: #f8fafc; background: #16181d; padding: 8px 14px; border-radius: 6px; border: 1px solid rgba(255, 255, 255, 0.1); text-decoration: none; font-size: 13px; font-weight: 600; display: flex; align-items: center; gap: 6px; transition: all 0.2s ease;">
                                📞 0765 948 524
                            </a>
                            <a href="https://wa.me/40765948524?text=Salut,%20am%20nevoie%20de%20un%20electrician." target="_blank" style="background-color: #25d366; color: #ffffff !important; padding: 8px 14px; border-radius: 6px; text-decoration: none; font-size: 13px; font-weight: 600; display: flex; align-items: center; gap: 6px; transition: all 0.2s ease;">
